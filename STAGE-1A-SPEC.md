...
Статус архитектуры: **заморожена на `ARCHITECTURE.md v1.2`**.
...
Если таблицы tasks/canvases/inbox ещё не реализованы, manifest явно
указывает отсутствие соответствующих секций, а не имитирует их наличие.
